...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading = false, icon, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-white/10 text-gray-300 border border-white/20 hover:bg-white/20 focus:ring-white/50',
      ...
      ghost: 'bg-transparent text-gray-300 hover:bg-white/10 focus:ring-white/50'
    };
